// i will get a string
// i need to return a neew string from the old string, I
// need to take out all the first c and everything before it,
// I also need to remvoe all 'Eek!'
// I also need to reverse the string and return it 


function catRe(str){
    let indc = str.indexOf('c')
    let final = str.slice(indc).replaceAll('Eek!', '').split(' ').reverse().join(' ').split('v')
